...
// Only enable debug routes in production for troubleshooting
if (process.env.NODE_ENV === 'production') {
  module.exports = router;
} else {
  // In development, provide a message that debug routes are disabled
  router.get('*', (req, res) => {
    ApiResponse.success(res, { message: 'Debug routes are only available in production' }, 200);
  });
  module.exports = router;
}
