...
import { FaEdit, FaSave, FaTimes, FaLock, FaFileAlt, FaTrashAlt, FaDownload } from 'react-icons/fa';

import styles from './ProfilePage.module.css';
import ChangePasswordForm from '../components/auth/ChangePasswordForm';
import Button from '../components/ui/Button/Button';
import Modal from '../components/ui/Modal';
import { getProfile, updateProfile, changePassword, updateProfileImage, UserProfileUpdateData } from '../services/userService';
...
const ProfilePage: React.FC = () => {
  ...
  return (
    <div className={styles.profileContainer}>
      ...
      <div className={styles.profileCard}>
        <div className={styles.profileSection}>
          <h2 className={styles.profileSectionTitle}>Gestión de Datos</h2>
          <p>Administre sus datos personales y privacidad.</p>
          
          <div style={{ display: 'flex', gap: '12px', flexWrap: 'wrap', marginTop: '16px' }}>
            <Button
              variant="secondary"
              onClick={() => navigate('/eliminar-datos')}
              icon={<FaDownload />}
              size="small"
            >
              Exportar Datos
