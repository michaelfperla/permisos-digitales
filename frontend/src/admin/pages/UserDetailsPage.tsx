...
import { getUserDetails, getUserApplications, enableUser, disableUser, Application, SecurityEvent } from '../services/adminService';
...
const UserDetailsPage: React.FC = () => {
  ...
  const {
    ...
    queryFn: () => getUserApplications(userId as string),
    enabled: !!userId, // Only run the query if userId is present
  });
