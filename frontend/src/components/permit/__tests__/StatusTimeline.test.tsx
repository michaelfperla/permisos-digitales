...
describe('StatusTimeline Component', () => {
  ...
  it('should render PENDING_PAYMENT status correctly', () => {
    render(<StatusTimeline currentStatus="PENDING_PAYMENT" applicationDates={mockDates} />);
  ...
  it('should render PROOF_SUBMITTED status correctly', () => {
    render(<StatusTimeline currentStatus="PROOF_SUBMITTED" applicationDates={mockDates} />);
  ...
  it('should render PAYMENT_RECEIVED status correctly', () => {
    render(<StatusTimeline currentStatus="PAYMENT_RECEIVED" applicationDates={mockDates} />);
  ...
  it('should render PERMIT_READY status correctly', () => {
    render(<StatusTimeline currentStatus="PERMIT_READY" applicationDates={mockDates} />);
  ...
  it('should render unknown status with simplified timeline', () => {
    ...
    render(<StatusTimeline currentStatus={unknownStatus} applicationDates={mockDates} />);
